...
func TestParseAuditorium(t *testing.T) {
	cases := []struct {
		...
		// Десятый этаж 51 к.1 без ведущего нуля: первые две цифры — этаж.
		// Подтверждено программой Дня открытых дверей 2025 (1001, 1006 —
		// «10 этаж»); раньше такие аудитории оставались без этажа.
		{"ЛП51_1/1001", "Ленинградский проспект, 51, корп. 1", "1001", intPtr(10), CampusLeningradsky},
		{"ЛП51_1/1006", "Ленинградский проспект, 51, корп. 1", "1006", intPtr(10), CampusLeningradsky},
